...
peer channel create -o orderer.example.com:7050 -c channel1 -f \
./channel-artifacts/channel1.tx --tls true --cafile /home/an/GCP_Hyperledger/vm/org1-1/fabric-samples/first-network/myscript/case4/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
